...
#labelling
label NaPocket and n. CA, "%s (Na Pocket motif)" % one_letter[resn]
label PIF and n. CA, "%s (PIF motif)" % one_letter[resn]
label CholesterolMotifs and n. CA, "%s (Cholesterol motif)" % one_letter[resn]
label DRY and n. CA, "%s (DRY motif)" % one_letter[resn]
label NPxxY and n. CA, "%s (NPxxY motif)" % one_letter[resn]
label CWxP and n. CA, "%s (CWxP motif)" % one_letter[resn]
